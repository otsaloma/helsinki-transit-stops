...
class TestConnectionPool(hts.test.TestCase):

    def setup_method(self, method):
        self.pool = hts.http.ConnectionPool(2)
        self.http_url = "http://github.com/otsaloma/helsinki-transit-stops"
        self.https_url = "https://github.com/otsaloma/helsinki-transit-stops"
...
class TestModule(hts.test.TestCase):
    ...
    def test_request_json__error(self):
        url = "https://github.com/otsaloma/helsinki-transit-stops"
        self.assert_raises(Exception, hts.http.request_json, url)

    def test_request_url(self):
        url = "https://github.com/otsaloma/helsinki-transit-stops"
        blob = hts.http.request_url(url, encoding="utf_8")
        assert blob.strip().startswith("<!DOCTYPE html>")

    def test_request_url__error(self):
        url = "http://xxx.yyy.zzz/"
        self.assert_raises(Exception, hts.http.request_url, url)
